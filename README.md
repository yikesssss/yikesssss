...
I build small, focused web projects — from hackathon apps tackling real problems to interactive visualizations that make abstract ideas easier to understand.

## Projects

### 🧠 [mind-pattern](https://github.com/yikesssss/mind-pattern)
